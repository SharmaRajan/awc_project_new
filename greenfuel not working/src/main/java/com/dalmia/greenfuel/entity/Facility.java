...
//    @ManyToOne
    ...
    public List<WasteType> getWaste() {
        return waste;
    }

    public void setWaste(List<WasteType> waste) {
        this.waste = waste;
    }
