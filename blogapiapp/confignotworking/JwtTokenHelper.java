...
public class JwtTokenHelper {
    ...
    // whatever the operations we have to perform on token we will keep it here
...
//    @Value("${jwt.secret}")
    ...
    // 2nd method to generate token for user
    ...
    // 3. According to JWS compact Serialization(https://tools.ieft.org/htmldraft-ieft-jose-j
